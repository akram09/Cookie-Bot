...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('next')
		.setDescription('Saves you message as a next point to discuss in future meetings')
	...
	async execute(interaction) {
        const m = interaction.options.getString('message')
            ...
            .setDescription('The following message will be saved in the PV to discuss in future Meetings:')
            ...
            interaction.reply({ embeds:[embed] });
                ...
                interaction.reply('It seems that you used this command outside a Meeting Thread !')
            }
